...
from server.rag.deal_rag import delete_article_route, add_article_route, add_article_group_route, delete_article_group_route, select_article_group_route
...
app.register_blueprint(add_article_route)
app.register_blueprint(add_article_group_route)
app.register_blueprint(delete_article_group_route)
app.register_blueprint(select_article_group_route)
