...
class iniit_config():
    def __init__(
        ...
        self.vis_font_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'paddle_ocr_torch', 'doc', 'simfang.ttf')
        self.rec_char_dict_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'paddle_ocr_torch','utils', 'ppocr_keys_v1.txt')
        ...
        self.e2e_model_path = e2e_model_path
        self.e2e_limit_side_len = 768
        self.e2e_limit_type = 'max'

        # PGNet parmas
        self.e2e_pgnet_score_thresh = 0.5
        self.e2e_char_dict_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'paddle_ocr_torch','utils', 'ic15_dict.txt')
