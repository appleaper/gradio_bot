...
def imgs_det_predict(img_path, det_algorithm, model_name):
    ...
    args.algorithm_type = config['det'][model_name].get('algorithm_type', args.algorithm_type)
...
if __name__ == "__main__":
    ...
    imgs_det_predict(img_path, 'DB', 'multilingual_ptocr_v3_det_infer')
