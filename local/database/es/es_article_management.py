...
class ElasticsearchManager:
    ...
    def insert_data(self, article_id, user_id, title, content, page_count, file_from, hash_check, embed_model_name, platform, database_type):
    ...
    def insert_data_format_df(self, df):
        ...
        for index, row in df.iterrows():
            ...
            embed_model_name = self._replace_nan(row['embed_model_name'])
            platform = self._replace_nan(row['platform'])
            database_type = self._replace_nan(row['database_type'])
